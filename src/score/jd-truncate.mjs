...
const KEEP_HEADERS = /^\s*#{0,3}\s*(responsibilities|what you.?ll do|requirements|qualifications|must have|nice to have|skills|your role|missions|profil|ce que tu feras|compétences)\b/im;
const DROP_HEADERS = /^\s*#{0,3}\s*(about us|benefits|perks|equal opportunity|diversity|how to apply|apply now|our story|who we are|why join|pourquoi nous rejoindre|avantages)\b/im;
